      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-header">
            ...
            <form action="{{ route('movings.update_before_select_equipment', $moving->id) }}" method="POST">
              @csrf @method('PUT')
              <div class="row">
                <div class="col-6">
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-sm btn-primary"><i class="fas fa-save"></i> Save & Select Equipment</button>
              </div>
          </form>
